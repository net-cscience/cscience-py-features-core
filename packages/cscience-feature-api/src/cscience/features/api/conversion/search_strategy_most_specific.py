...
class SearchStrategyMostSpecific(SearchStrategyBase):
    ...
    def __init__(self, feature: FeatureBase, input_type: type, output_type: type):
    ...
    def search(self, recordset: dict[tuple[FeatureBase,type,type], Converter]) -> Converter:
        ...
        raise ValueError(f"No converter found for feature {self.feature} with input type {self.input_type} and output type {self.output_type}")
