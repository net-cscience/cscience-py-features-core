# Exported code on 2026-07-10 18:43:28.929079 with root dir D:\myRepo\net.cscience\cscience-py-features-core\packages
...
class ConfigBase(BaseModel, ABC):
    ...
    Configurations can either be stored:

    1. In one file per feature.
    2. In a unified JSON file, grouped by namespace.
    """
    ...
    # Shared between all subclasses because unified configurations use
    # the same file.
    _unified_config_lock: ClassVar[RLock] = RLock()

    # Persistence metadata. These values are not part of the JSON model.
    _mode: ConfigMode = PrivateAttr(
        default=ConfigMode.CONFIG_PER_FEATURE
    )
    _config_path: pathlib.Path = PrivateAttr()

    def model_post_init(self, __context: Any) -> None:
        """
        Configure the default persistence location.
        """
    ...
    def configure_storage(
        ...
        *,
        ...
        """
        Configure how and where this instance is persisted.

        `config_path` always refers to the complete JSON file path.
        """
        self._mode = mode
        ...
        match mode:
            ...
            case ConfigMode.CONFIG_PER_FEATURE:
                self._config_path = (
                    self._get_resources_folder()
                    / f"config_{self._namespace()}.json"
                )
    ...
    @classmethod
    def _get_resources_folder(cls) -> pathlib.Path:
        """
        Return the default configuration resource directory.
        """
        resources_folder = (
    ...
    def persist(self) -> None:
        ...
        # Produces a dictionary containing only JSON-compatible values.
    ...
    def _persist_unified(
        ...
        *,
        ...
        """
        Replace this feature's namespace in the unified configuration.
        """
        namespace = self._namespace()

        with self._unified_config_lock:
            document = self._read_json_object(
                target,
                missing_ok=True,
            )

            # Preserve every other namespace and replace only this one.
    ...
    def _load_unified(
        ...
        """
        Load and validate this feature's section from the unified file.
        """
        document = self._read_json_object(
            source,
            missing_ok=False,
    ...
    def _write_json_atomic(
        *,
        ...
        """
        Write a JSON document using a temporary file.
        """
        ...
        # A unique name avoids collisions between temporary writes.
    ...
    def _replace_state(
        ...
        """
        Replace only the validated Pydantic model state.

        Persistence metadata such as `_mode` and `_config_path` is
...
class ConfigMode(Enum):
    ...
    """
    Configuration for the mode of how config files were stored.
    """

    UNIFIED_CONFIG = 1
    CONFIG_PER_FEATURE= 2
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\audio_bytes_base.py
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\batch_base.py
from abc import ABC
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\core_datatype.py
from abc import ABC
from typing import Generic, TypeVar
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\embedding_base.py
from abc import ABC
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\image_bytes_base.py
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\media_bytes_base.py
from abc import ABC
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\vector_base.py
from abc import ABC
...
# From cscience-feature-api\src\cscience\features\api\datatypes\base\vector_batch_base.py
from abc import ABC
...
# From cscience-feature-api\src\cscience\features\api\datatypes\core_conversion_provider.py
import base64
...
# From cscience-feature-api\src\cscience\features\api\datatypes\primitives_vectors\bool_vector_batch.py
...
# From cscience-feature-api\src\cscience\features\api\datatypes\primitives_vectors\float_vector_batch.py
from cscience.features.api.datatypes.base.embedding_base import EmbeddingBase
...
# From cscience-feature-api\src\cscience\features\api\datatypes\primitives_vectors\int_vector_batch.py
from .primitive_vector_batch_base import PrimitiveVectorBatchBase
...
# From cscience-feature-api\src\cscience\features\api\datatypes\primitives_vectors\primitive_vector_base.py
from abc import ABC
from typing import Generic, TypeVar
...
# From cscience-feature-api\src\cscience\features\api\datatypes\primitives_vectors\primitive_vector_batch_base.py
from abc import ABC
from collections.abc import Mapping
from typing import Generic, TypeVar
...
# From cscience-feature-api\src\cscience\features\api\datatypes\spatial\spatial_primitive_vector_batch_base.py
from abc import ABC
from typing import Generic, TypeVar
...
# From cscience-feature-api\src\cscience\features\api\datatypes\spatial\spatial_vector_batch_base.py
from abc import ABC
from collections.abc import Mapping, Sized
from typing import Generic, TypeVar
...
# From cscience-feature-api\src\cscience\features\api\datatypes\spatial\spatial_vector_batch_data.py
from collections.abc import Mapping
from dataclasses import dataclass
from typing import Generic, TypeVar
...
# From cscience-feature-api\tests\test_config.py
import unittest
...
# From cscience-feature-api\tests\test_conversion.py


# From cscience-feature-api\tests\test_feature.py
import unittest
...
# From cscience-feature-api\tests\test_service_info.py
...
# From cscience-feature-clip-spatial\tests\test_visual_indexing.py
import unittest
from pathlib import Path
